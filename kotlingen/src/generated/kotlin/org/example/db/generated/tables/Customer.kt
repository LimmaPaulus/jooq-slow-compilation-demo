...
import org.example.db.generated.indexes.IDX_FK_ADDRESS_ID
import org.example.db.generated.indexes.IDX_FK_STORE_ID
import org.example.db.generated.indexes.IDX_LAST_NAME
import org.example.db.generated.keys.CUSTOMER_PKEY
import org.example.db.generated.keys.CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY
...
open class Customer(
     ...
     */
    val STORE_ID: TableField<CustomerRecord, Short?> = createField(DSL.name("store_id"), SQLDataType.SMALLINT.nullable(false), this, "")
     ...
     */
    val ADDRESS_ID: TableField<CustomerRecord, Short?> = createField(DSL.name("address_id"), SQLDataType.SMALLINT.nullable(false), this, "")
    ...
    override fun getReferences(): List<ForeignKey<CustomerRecord, *>> = listOf(CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY)
