...
import org.example.db.generated.indexes.IDX_FK_CUSTOMER_ID
import org.example.db.generated.indexes.IDX_FK_RENTAL_ID
import org.example.db.generated.indexes.IDX_FK_STAFF_ID
import org.example.db.generated.keys.PAYMENT_PKEY
import org.example.db.generated.keys.PAYMENT__PAYMENT_CUSTOMER_ID_FKEY
import org.example.db.generated.keys.PAYMENT__PAYMENT_RENTAL_ID_FKEY
import org.example.db.generated.keys.PAYMENT__PAYMENT_STAFF_ID_FKEY
...
open class Payment(
    ...
    /**
     * The column <code>public.payment.payment_time</code>.
     */
    val PAYMENT_TIME: TableField<PaymentRecord, LocalTime?> = createField(DSL.name("payment_time"), SQLDataType.LOCALTIME(6), this, "")
