...
import org.example.db.generated.indexes.IDX_FK_FILM_ID
import org.example.db.generated.keys.FILM_ACTOR_PKEY
import org.example.db.generated.keys.FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY
import org.example.db.generated.keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY
...
open class FilmActor(
     ...
     */
    val ACTOR_ID: TableField<FilmActorRecord, Short?> = createField(DSL.name("actor_id"), SQLDataType.SMALLINT.nullable(false), this, "")

    /**
     * The column <code>public.film_actor.film_id</code>.
     */
    val FILM_ID: TableField<FilmActorRecord, Short?> = createField(DSL.name("film_id"), SQLDataType.SMALLINT.nullable(false), this, "")
