...
open class FilmListRecord() : TableRecordImpl<FilmListRecord>(FilmList.FILM_LIST), Record8<Int?, String?, String?, String?, BigDecimal?, Short?, MpaaRating?, String?> {
    ...
    override fun field1(): Field<Int?> = FilmList.FILM_LIST.FID
    ...
    override fun value1(value: Int?): FilmListRecord {
        this.fid = value
        return this
    }
    ...
    override fun values(value1: Int?, value2: String?, value3: String?, value4: String?, value5: BigDecimal?, value6: Short?, value7: MpaaRating?, value8: String?): FilmListRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
