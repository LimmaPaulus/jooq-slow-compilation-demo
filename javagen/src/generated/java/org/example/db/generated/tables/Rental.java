...
public class Rental extends TableImpl<RentalRecord> {
    ...
    public List<ForeignKey<RentalRecord, ?>> getReferences() {
        return Arrays.asList(Keys.RENTAL__RENTAL_INVENTORY_ID_FKEY, Keys.RENTAL__RENTAL_CUSTOMER_ID_FKEY, Keys.RENTAL__RENTAL_STAFF_ID_KEY);
    }
    ...
    public Staff staff() {
        if (_staff == null)
            _staff = new Staff(this, Keys.RENTAL__RENTAL_STAFF_ID_KEY);
